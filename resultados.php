...
?>
    ...
    <form action="resultados.php" method="POST">
        ...
        <div class="row">
            ...
            <div class="col-3" id="div_filtro_setor" style="text-align: left; background-color: #f9f9f9 !important;">
    ...
    <?php 
        ...
        if($var_indicador == 'Desvio'){
            ...
            include 'resultados/desvio/estrutura_desvio.php';
    ...
    <?php 
        ...
        if($var_indicador == 'Gerencia'){
            ...
            include 'resultados/gerencia/estrutura_gerencia.php';
        }
    ?>
    ...
    <?php 
        ...
        if($var_indicador == 'Acumulado'){
            include 'resultados/acumulado/estrutura_acumulado.php';
        }
    ?>
