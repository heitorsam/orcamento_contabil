...
<<<<<<< Updated upstream
--ANEXOS CONTA CONTABIL

DROP TABLE orcamento_contabil.ANEXOS;
CREATE TABLE orcamento_contabil.ANEXOS(
...
DROP TABLE orcamento_contabil.NECESSIDADE_PREVISTA;
CREATE TABLE orcamento_contabil.NECESSIDADE_PREVISTA(

CD_NECESSIDADE_PREVISTA INT NOT NULL,
PERIODO                 VARCHAR(7) NOT NULL,
VL_NECESSIDADE_PREVISTA FLOAT NOT NULL,   
CD_USUARIO_CADASTRO     VARCHAR(20) NOT NULL,
HR_CADASTRO             TIMESTAMP NOT NULL,
CD_USUARIO_ULT_ALT      VARCHAR(20),
HR_ULT_ALT              TIMESTAMP,

CONSTRAINT PK_CD_NECESSIDADE_PREVISTA PRIMARY KEY (CD_NECESSIDADE_PREVISTA),
--UNIQUE_KEY
CONSTRAINT UK_PERIODO_NECESSIDADE_PREV UNIQUE (PERIODO)
>>>>>>> Stashed changes
...
<<<<<<< Updated upstream
DROP SEQUENCE seq_anexos;
CREATE SEQUENCE orcamento_contabil.seq_anexos
=======
DROP SEQUENCE SEQ_CD_NECESSIDADE_PREVISTA;
CREATE SEQUENCE SEQ_CD_NECESSIDADE_PREVISTA
>>>>>>> Stashed changes
START WITH 1    
INCREMENT BY   1
NOCACHE
